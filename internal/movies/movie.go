...
type Short struct {
	...
	ID            int    `json:"id" firestore:"id" bson:"id"`
	...
	VoteAverage   float32 `json:"vote_average" firestore:"vote_average" bson:"vote_average"`
	VoteCount     uint32  `json:"vote_count" firestore:"vote_count" bson:"vote_count"`
	Year          string
